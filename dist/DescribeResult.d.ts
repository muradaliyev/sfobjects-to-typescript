...
export type ExtraTypeInfo = "imageurl" | "personname" | "plaintextarea" | "richtextarea" | "switchablepersonname" | "externallookup" | "indirectlookup";
export type FieldType = "string" | "boolean" | "int" | "double" | "date" | "datetime" | "base64" | "id" | "reference" | "currency" | "textarea" | "percent" | "phone" | "url" | "email" | "combobox" | "picklist" | "multipicklist" | "anyType" | "location" | "time" | "encryptedstring" | "address" | "complexvalue";
export interface FilteredLookupInfo {
    controllingFields: string[];
    dependent: boolean;
    optionalFilter: boolean;
}
export type SOAPType = "tns:ID" | "xsd:anyType" | "xsd:base64Binary" | "xsd:boolean" | "xsd:date" | "xsd:dateTime" | "xsd:double" | "xsd:int" | "xsd:string" | "xsd:time" | "urn:address" | "urn:JunctionIdListNames" | "urn:location" | "urn:RecordTypesSupported" | "urn:RelationshipReferenceTo" | "urn:SearchLayoutButtonsDisplayed" | "urn:SearchLayoutFieldsDisplayed";
